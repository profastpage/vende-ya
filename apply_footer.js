...
const endIndex = text.lastIndexOf(endStr);
...
if (startIndex !== -1 && endIndex !== -1) {
  ...
  console.log("Replaced Zona 4 successfully");
} else {
  console.log("Could not find start or end index for Zona 4. Start:", startIndex, "End:", endIndex);
}