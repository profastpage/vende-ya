...
export function AuctionCard({ auction, className }: { auction: Auction; className?: string }) {
  ...
  return (
    <Card className={cn(
      'group relative overflow-hidden rounded-xl border bg-card shadow-soft hover:shadow-lift transition-all duration-300 cursor-pointer',
      className
    )}>
      {/* Image */}
...
export function LiveStreamCard({ stream, className }: { stream: LiveStream; className?: string }) {
  ...
  return (
    <Card className={cn(
      'group relative overflow-hidden rounded-xl border bg-card shadow-soft hover:shadow-lift transition-all duration-300 cursor-pointer min-w-[200px]',
      className
    )}>
...
export function SellerChip({ profile, className }: { profile: Profile; className?: string }) {
  return (
    <div className={cn(
      'flex flex-col items-center gap-1.5 p-3 rounded-xl border bg-card min-w-[100px] hover:shadow-soft transition-shadow cursor-pointer',
      className
    )}>
