...
import { createExpressProduct } from '@/app/studio/actions'
    ...
    <div className="flex flex-col md:flex-row w-full h-[100dvh] bg-zinc-950 text-foreground overflow-hidden">
      ...
      <div className="w-full md:w-[400px] flex-shrink-0 bg-zinc-950 flex flex-col h-full overflow-y-auto p-6">
        ...
        <div className="bg-rose-500/10 border border-rose-500/20 rounded-2xl p-5">
          ...
          <button className="w-full bg-rose-500/20 text-rose-400 font-bold py-3 rounded-xl hover:bg-rose-500/30 transition-colors text-sm">
            Finalizar En Vivo
          </button>
        </div>
      </div>
