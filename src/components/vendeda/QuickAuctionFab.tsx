...
import { Plus, Radio, Video, Sparkles, ChevronUp } from 'lucide-react'
          ...
          <>
            ...
            >
              <Button
                ...
                onClick={() => { /* route to /create?type=live */ setOpen(false) }}
              >
            ...
            >
              <Button
                variant="outline"
                className="bg-card shadow-lift rounded-full pl-4 pr-5 h-12 gap-2"
                onClick={() => { /* route to /create?type=ai */ setOpen(false) }}
              >
            ...
            >
              <Button
                variant="outline"
                className="bg-card shadow-lift rounded-full pl-4 pr-5 h-12 gap-2"
                onClick={() => { /* route to /create?type=quick */ setOpen(false) }}
              >
