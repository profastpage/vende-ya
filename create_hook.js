...
const dir = path.join('C:\\dev\\CLIENTES\\VENDE YA\\vende-ya-main\\src\\hooks');
...
fs.writeFileSync(path.join(dir, 'useLiveViewers.ts'), content, 'utf8');
console.log('Created useLiveViewers hook');