...
const regex = /<div className="flex flex-col w-full max-w-md mx-auto h-\[100dvh\] md:h-\[100vh\] bg-background overflow-hidden text-foreground relative md:border-x md:border-white\/10 md:shadow-2xl">[\s\S]*?<\/div>\s*<\/div>\s*<\/div>/;

const newStructure = `<div className="flex flex-col md:flex-row w-full h-[100dvh] bg-background overflow-hidden text-foreground">
      
      {/* ========================================================
          COLUMNA IZQUIERDA: VIDEO (PC) / ARRIBA (MOBILE)
          ======================================================== */}
      <div className="w-full md:w-2/3 lg:w-3/4 h-[40vh] md:h-full shrink-0 bg-black relative flex flex-col border-b md:border-b-0 md:border-r border-white/5 z-20">
          ...
          <div className="flex items-center gap-3 pointer-events-auto">
            ...
            {isSeller && (
              <button 
                ...
                disabled={isEnding}
                className="flex items-center gap-2 px-4 py-2 rounded-full bg-red-600/90 backdrop-blur-md border border-red-500/50 hover:bg-red-500 transition-colors text-white font-bold text-xs disabled:opacity-50"
              >
      ...
      {/* ========================================================
          ...
          ======================================================== */}
      <div className="flex-1 md:w-1/3 lg:w-1/4 flex flex-col min-h-0 bg-zinc-950 relative z-10 w-full shadow-2xl">
