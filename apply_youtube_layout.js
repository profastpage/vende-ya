...
// We will replace both DesktopLayout and MobileLayout, and the return statement with a unified layout.
const unifiedLayout = `
...
if (desktopStartIdx !== -1 && endIdx !== -1) {
  text = text.slice(0, desktopStartIdx) + unifiedLayout + '\n}';
}

// Ensure ChevronRight is imported just in case
